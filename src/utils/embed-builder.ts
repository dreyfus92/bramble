 ...
 * A warm, inviting teal color.
 */
export const EMBED_BRAND_COLOR = 0x2d9c83;
 ...
 *   .setTitle("Book Club Poll")
 *   .setDescription("What should we read next?")
 *   .setColor(EMBED_BRAND_COLOR)
 *   .addField({ name: "Option 1", value: "The Great Gatsby", inline: true })
 *   .setFooter("Vote by clicking a button below")
 *   .setTimestamp()
 *   .build();
 * ```
 */
